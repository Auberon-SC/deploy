...
def git():
    ...
    try:
        repo = Repo()
        LOGGER("ZEINZO").info(f"Git Client Found")
    except GitCommandError:
        LOGGER("ZEINZO").info(f"Invalid Git Command")
        ...
        LOGGER("ZEINZO").info("Fetched Latest Updates")
    ...
    if is_heroku:
        if HEROKU_API_KEY and HEROKU_APP_NAME:
            try:
                ...
                LOGGER("ZEINZO").info(f"Heroku App Configured")
